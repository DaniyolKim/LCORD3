...
export const usePlayersStore = create((set, get) => ({
  ...
  getPlayersByRace: (race) => {
    const { players } = get();
    return players.filter(player => player.종족.includes(race));
  },
...
// 편의를 위한 헬퍼 함수들
export const getPlayerById = (id) => usePlayersStore.getState().getPlayerById(id);
export const getPlayerByName = (name) => usePlayersStore.getState().getPlayerByName(name);
export const getPlayersByTeam = (teamNumber) => usePlayersStore.getState().getPlayersByTeam(teamNumber);
export const getPlayersByRace = (race) => usePlayersStore.getState().getPlayersByRace(race);
export const getPlayersByTier = (tier) => usePlayersStore.getState().getPlayersByTier(tier);
